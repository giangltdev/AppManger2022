                ...
                var pg = {
                    ...
                    populate: function () {
                        ...
                        var pagerNumber = $("<ul/>").addClass(
                            pfx + "datatable-pager-nav my-2 mb-sm-0"
                        );
                        ...
                        if (Plugin.getOption("toolbar.items.info")) {
                            pg.pagerLayout["info"] = $("<div/>")
                                .addClass(
                                    pfx + "datatable-pager-info my-2 mb-sm-0"
                                )
                                .append(
                                    $("<span/>").addClass(
                ...
                if (Extension.selectorEnabled()) {
                    ...
                    $(datatable).on(
                        ...
                        function (e, ids) {
                            ...
                            storage[
                                "selectedRows"
                            ] = Extension.selectedRows.filter(Extension.unique);
                            storage[
                                "unselectedRows"
                            ] = Extension.unselectedRows.filter(
                                Extension.unique
                            );
