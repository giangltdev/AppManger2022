            ...
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <div class="quick-search quick-search-dropdown" id="kt_quick_search_dropdown">
                        <!--begin:Form-->
                        <form method="get" autocomplete="off" class="quick-search-form">
                            ...
                            <div id="search_ajax" class="dropdown-menu w-100"></div>
                        </form>
                        <!--end::Form-->
                        <!--begin::Scroll-->
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        ...
                        {{-- <img class="h-20px w-20px rounded-sm" src="{{ asset('assets/media/svg/flags/united-states.svg') }}" alt="" /> --}}
                        {{-- @else --}}
                        <img class="h-20px w-20px rounded-sm" src="{{ asset('assets/media/svg/flags/vietnam.svg') }}" alt="" />
                        {{-- @endif --}}
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item active">
                            {{-- <a href="{{ route('change.lang', 'vi') }}" class="navi-link"> --}}
                                <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('assets/media/svg/flags/vietnam.svg') }}" alt="" />
                                </span>
                        ...
                        <li class="navi-item">
                            {{-- <a href="{{ route('change.lang', 'en') }}" class="navi-link"> --}}
                                <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('assets/media/svg/flags/united-states.svg') }}" alt="" />
                                </span>
