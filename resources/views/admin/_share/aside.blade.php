            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item @yield('active_home')" aria-haspopup="true">
                    <a href="{{ route('admin') }}" class="menu-link">
                        ...
                        {{-- <span class="menu-text">{{ __('text.home') }}</span> --}}
                        <span class="menu-text">Trang chủ</span>
                    </a>
                </li>
                <!--begin:: Order-->
                <li class="menu-item menu-item-submenu @yield('active_design')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Design\Image.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24" />
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('oder.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item menu-item-submenu @yield('active_personnel')" aria-haspopup="true"
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('personnel.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Thêm nhân sự</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item menu-item-submenu @yield('active_role')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin:: icon -->
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('roles.index') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">Tất cả các quyền</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('roles.create') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">Thêm chức vụ</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('roles.createPer') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Thêm quyền</span>
                                </a>
                            </li>
                        </ul>
                    </div>
