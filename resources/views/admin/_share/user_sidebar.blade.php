...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Thông tin người dùng
            <small class="text-muted font-size-sm ml-2">12 tin nhắn</small>
        </h3>
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"
                    style="background-image:url({{ asset('images/posts/' . Auth::user()->images) }})"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#"
                    class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->name }}</a>
                <div class="text-muted mt-1">{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</div>
                <div class="navi mt-2">
                    ...
                    document.getElementById('logout-form').submit();">
                        <span class="svg-icon svg-icon-primary">
                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Navigation\Sign-out.svg--><svg
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            {{-- <a href="{{ route('user.user_info', Auth::user()->id) }}" class="navi-item"> --}}
                ...
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Xem thêm về tài khoản
            ...
            <a href="#" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Tin nhắn</div>
                        <div class="text-muted">Hộp thư đến</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
