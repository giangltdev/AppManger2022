...
@section('info', 'active')
@section('name_page', 'Cập nhật tài khoản ' .$user->name)
        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted font-weight-bold font-size-sm mt-1">Bạn có thể cập nhật thông tin cá nhân ngay tại đây</span>
                </div>
            ...
            <!--end::Header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('user.update_info', $user->id) }}" method="POST" enctype="multipart/form-data" role="form" >
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            ...
                            <span class="form-text text-muted">Chúng tôi sẽ không bao giờ chia sẻ dữ liệu của bạn với bất kỳ ai khác.</span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div class="input-group input-group-lg input-group-solid">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid" disabled value="{{ $user->department }}"  />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div class="input-group input-group-lg input-group-solid">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid" disabled value="{{ $user->rank }}"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div class="input-group input-group-lg input-group-solid">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-solid" disabled value="{{ $user->team }}"  />
                            </div>
                        </div>
                    </div>
