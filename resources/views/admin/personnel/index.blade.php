...
@section('active_personnel', 'menu-item-active')
@section('name_page', 'Trang quản lý nhân sự')
...
@section('main')
    ...
    <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
        ...
        <div class="alert-text">Có thể thêm, chỉnh sửa thông tin, xóa và cập nhật thông tin của nhân sự.
        </div>
    </div>
    <!--end::Notice-->
    <!--begin::Card-->
    ...
    <div class="card card-custom pb-5" >
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Button-->
                <a href="{{ route('personnel.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            {{-- @foreach ($users as $key => $user)
                <tr>
                    ...
                    <td class="text-center">
                        @if ($user->is_active == 1)
                            <span class="switch switch-sm d-flex justify-content-center">
                                <label>
                                    <input type="checkbox" checked="checked" name="select" disabled="disabled">
                                    <span></span>
                                </label>
                            </span>
                        @else
                    ...
                    <td class="text-center">
                        <a href="{{ route('user.edit', $user->id) }}" class="edit_admin">
                    ...
                    <td class="text-center">
                        <form class="delete_button" action="{{ route('user.destroy', $user->id) }}" method="POST">
                            @csrf
